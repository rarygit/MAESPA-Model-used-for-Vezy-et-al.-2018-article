...
! Array declarations.
    ...
    ! Functions
    REAL, EXTERNAL :: AVERAGEVAL,CALCRMW,TK,ETCAN,RESP,RESPW,GRESP
    ...
    REAL PARUS(MAXHRS,MAXP),APARUS(MAXHRS,MAXP)! CBF MAXT-> MAXP
    REAL PSUS(MAXHRS,MAXP),ETUS(MAXHRS,MAXP)! CBF MAXT -> MAXP
    ...
    REAL WETTINGBOT(100),WETTINGTOP(100)  !CBF WETTINGTOP(10)->WETTINGTOP(100)
    !CBF WETTINGBOT(10)->WETTINGBOT(100)
    ...
    REAL RTEMP, RTEMPB, RTEMPR, RUNOFF, RUTTERB, RUTTERD, SCLOSTTOT, SHADEHT, SHAPE, SMD1, SMD2, SCLOSTTOT3
    ...
    REAL PREVTAIRCAN, PREVVPDCAN,DOWNTHAV, HTOT
    REAL NPOINTTHROUGH,XSTEP,YSTEP,XGRID,YGRID,SUNLAGRID,FBEAMTHROUGH(MAXHRS,3),FCOVER,S,S1,BPATH
    ...
    REAL PLANTWATER(MAXDATE+1, MAXT) ! CBF changed PLANTWATER(MAXDATE, MAXT)
    
    !Evaporation of wet canopy  !glm canopy evap 
    REAL EV,drycan, EVMM, FH2OEV(MAXT,MAXHRS),EVTABLE(MAXT,MAXP), EVMMSPEC(MAXSP),EVMMTOT,TOTH2OEV(MAXT),CANOPY_STORE_I  !glm canopy evap 
    REAL GROUNDAREA

    !For timing the code ! CBF
    REAL START, FINISH
