...
Sim.Path= "/data/sorties/rvezy/Graecopy_Server/Eucalyptus/2-Simulations_FullPeriod2012/V2.Iter20/Sim 1"
# 4- the location of the R libraries:
...
if(any(lapply(pckg, require, character.only = TRUE, lib.loc=librariesPath)==F)){
  install.packages(pckg,lib = librariesPath, Ncpus= length(pckg))  
}
