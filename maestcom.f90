...
!=======================================================================================
    ...
    INTEGER, PARAMETER :: MAXSP = 5         ! Maximum no. of species (RAD).
    ...
    !REAL, PARAMETER :: EMLEAF = 0.98       ! Emissivity of thermal radiation by leaf café
    !REAL, PARAMETER :: EMSOIL = 0.975       ! Emissivity of thermal radiation by soil café
